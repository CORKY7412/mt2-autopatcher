...
import cpp.game.metin2.crypto.PrivateKeyReader;
...
public class PatchCreator
{
    ...
    public static void main(String[] args)
    {
        try
        {
            ...
            File launcher = new File(Constants.baseDirectory + "\\latest_metin2.exe");
            String launcherHash = FileHelper.getSha256Hash(launcher);

            // Copy latest launcher into the upload directory
            Files.copy(launcher.toPath(), Paths.get(Constants.uploadDirectory  + "\\latest_metin2.exe"));
